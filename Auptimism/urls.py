...
from auptimism_main.views import home, login, logout, add_profile, create_activity, assign, homeplan, seechild, \
    show_activity, nochild, noactivity, show, view_activity, iep, view_child, done
...
urlpatterns = [
    ...
    path('viewactivity/<str:title>/',view_activity,name="view_activity"),
